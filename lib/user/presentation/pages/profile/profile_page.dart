  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UserLoginBloc, UserLoginState>(
      builder: (context, state) {
        return BlocBuilder<MainUserBloc, MainUserState>(
          builder: (context, state) {
            return SafeArea(
                child: Scaffold(
                    appBar: AppBar(),
                            ...
                            child: Column(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                     Text('select your own theme',style: Theme.of(context).textTheme.titleMedium,),
                                    Wrap(
                                      children: List.generate(
                                          ConstColor().listOfColor.length,
                                          (index) {
                                        return GestureDetector(
                                          onTap: () {
                                            BlocProvider.of<MainUserBloc>(
                                                    context)
                                                .add(OnColorChangeEvent(
                                                    index: index));
                                          },
                                          child: Container(
                                            margin: const EdgeInsets.all(10),
